...
class RecordingsControllerTest < ActionController::TestCase
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post :create, recording: { filename: @recording.filename, finished: @recording.finished, show_id: @recording.show_id, started: @recording.started, title: @recording.title }
    end
  ...
  test "should update recording" do
    patch :update, id: @recording, recording: { filename: @recording.filename, finished: @recording.finished, show_id: @recording.show_id, started: @recording.started, title: @recording.title }
    assert_redirected_to recording_path(assigns(:recording))
  end
